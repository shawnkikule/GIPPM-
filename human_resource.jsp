               ...
               <div class="middle_cont">
                  <div class="container-fluid">
                     <div class="row column_title">
                        ...
                        shor=  checkdb.executeQuery("select count(staff_id) as shstaff from staff where allocation='"+1+"'");
                    while(shor.next()){
                        sh = shor.getString("shstaff");
                        out.println(sh);
        }%></span></p>
                                                   </div>
                                                </div>
                        ...
                        mid=  checkdb.executeQuery("select count(staff_id) as mdstaff from staff where allocation='"+2+"'");
                    while(mid.next()){
                        md = mid.getString("mdstaff");
                        out.println(md);
        }%></span></p>
                                                   </div>
                        ...
                        lon=  checkdb.executeQuery("select count(staff_id) as lostaff from staff where allocation='"+3+"'");
                    while(lon.next()){
                        lo = lon.getString("lostaff");
                        out.println(md);
        }%></span></p>
                                                   </div>
                                          ...
                                          <div class="table_price full">
                                             <div class="inner_table_price">
                                                ...
                                                <div class="price_table_inner">
                                                   <div class="cont_table_price_blog">
                                                      <p class="red_color"><span class="price_no"><%
                        unassign=  checkdb.executeQuery("select count(staff_id) as nonestaff from staff where allocation='"+0+"'");
                    while(unassign.next()){
                        none = unassign.getString("nonestaff");
                        out.println(none);
        }%></span></p>
                                                   </div>
