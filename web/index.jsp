<%-- 
    Document   : index
    Created on : Aug 2, 2022, 6:47:40 PM
    Author     : HP
--%>
...
<head>
    <meta charset="utf-8">
    <title>GIPPM Dairy Enterprise</title>
        ...
        <div class="row bg-secondary py-1 px-xl-5">
            <div class="col-lg-6 d-none d-lg-block">
                <div class="d-inline-flex align-items-center h-100">
                    <a class="text-body mr-3" href=""><b>You can show interest in a product by tapping the ❤. To purchase a product, you need to Sign In</b></a>
                </div>
            </div>
            <div class="col-lg-6 text-center text-lg-right">
                <div class="d-inline-flex align-items-center">
                    <div class="btn-group">
                        <button type="button" class="btn btn-sm btn-light dropdown-toggle" data-toggle="dropdown">Sign In as:</button>
        ...
        <div class="row border-top mx-xl-5 py-4" style="border-color: rgba(256, 256, 256, .1) !important;">
            <div class="col-md-6 px-xl-0">
                <p class="mb-md-0 text-center text-md-left text-secondary">
                    &copy; <a class="text-primary" href="#">2022 GIPPM Dairy Enterprise</a>. Designed with inspiration from
